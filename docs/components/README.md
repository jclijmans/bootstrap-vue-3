...
<ClientOnly>
    <b-list-group>
        ...
        <b-list-group-item>
            <RouterLink to="./Table.html">Table</RouterLink>- For displaying tabular data. &lt;b-table&gt; supports pagination, filtering, sorting, custom rendering, events, and asynchronous data.
        </b-list-group-item>
    </b-list-group>
</ClientOnly>